...
public class Main {
    public static void main(String[] args) {
        AssetManagementService assetManagementService = new AssetManagementService();
        // Client 1 with access
        AssetManagementProxy client1Proxy = new AssetManagementProxy(assetManagementService, "001");
        client1Proxy.getAssetData();
        client1Proxy.provideInvestmentAdvice();
        client1Proxy.allocateAssets();
        client1Proxy.executeInvestmentDecision();
    }
}
