package org.example.s09_decorator.compliance_check;
...
public class Main {
    public static void main(String[] args) {
        Transaction transaction = new BasicTransaction();
        transaction = new AMLCheckDecorator(transaction);
        transaction = new IdentityVerificationDecorator(transaction);
